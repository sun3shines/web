...
from cloudcommon.common.bufferedhttp import http_connect
from swiftclient import ClientException, json_loads
from cloudcommon.common.utils import normalize_timestamp
from cloudcommon.common.http import HTTP_NO_CONTENT, HTTP_INSUFFICIENT_STORAGE, \
