...
from cloudlib.common.bufferedhttp import http_connect
from swiftclient import ClientException, json_loads
from cloudlib.common.utils import normalize_timestamp
from cloudlib.common.http import HTTP_NO_CONTENT, HTTP_INSUFFICIENT_STORAGE, \
